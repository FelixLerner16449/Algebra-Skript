...
\section{Galois correspondence}
    ...
    \subsection{Fundamental theorem}
        ...
        So (2) gives us (in comparison to \ref{cor:1.3}) that all of that, also the lower extension is Galois. It is a caracterization of when this is the case.
