...
\separline{VL 15}
    \begin{proof}[Proof of \ref{prop:burnside}]
        ...
        Let $\phi'$ be rank 1 endomorphism in $\End(S)$. Since $\phi'$ has rank 1, we choose $S'$ a genarator of $\Img \phi'$ and $\alpha'\in S^*$ such that $\phi'(v) 0 \alpha'(v)s'$ 
...
\section{Schur-Weyl duality}
    \subsection{Commutant and double commutant}
        \begin{definition}{}{3.28}
            ...
            \begin{equation*}
                C(S):= \{u \in \End(V) \ | \ us = su \forall s \in S\}
            \end{equation*}
        \end{definition}
...
\separline{VL 18}
        ...
        \begin{proposition}{}{3.31}
            Let $A,B$ be two finite-dimensional $\C$-algebras and $\varphi: A \to B$ be a surjective $\C$-algebra homomorphism. Then if $A$ is semisimple, so is $B$. 
        \end{proposition}
