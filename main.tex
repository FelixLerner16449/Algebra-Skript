...
\section{Integrality and divisibility}
    ...
    \begin{proof}
        ...
        \end{equation*}
        But this means $b | a^n$. But since $\gcd(a,b) = 1$, this is only possible if $b = 1$ (note that we choose $b \in \N$), hence $x \in \Z$.
    \end{proof}
    \begin{lemma}{}{2.35}
    ...
    To prove the theorem, we need two preliminary resulsts.
    ...
    \begin{proof}
        ...
        \end{equation*}
        but the left-hand side is in $\overline{\Z} \cap \Q = \Z$, but so must be the right-hand side, which is a contradiction.

        Therefore $p^t$ and $\chi_j(e)$ are coprime. Bèzout tells us that there exist $a,b \in \Z$:
        \begin{equation*}
            a p^t + b \chi_j(e) = 1
        \end{equation*}
    ...
    \begin{exercise}{}{15}
        \begin{enumerate}
            \item Show that fore three distinct prime number $p,q,r$ a group of order $pqr$ is solvable.
