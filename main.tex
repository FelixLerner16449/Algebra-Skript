...
\section{Left regular representation}
    ...
    \end{equation*}
    We obtained: $\C(G) \cong S_1 ^{\oplus \dim S_1} \oplus \dots \oplus S_t^{\dim S_t}$. If we denote $d_i := \dim S_i$, then $\#G = d-1^2 + \dots + d_t^2$.
    ...
    \end{proof}
    The inverse map is called the Fourier inversion formula (see for example Proposition \textit{11} in the book of Serre \cite{Serre.20}).
