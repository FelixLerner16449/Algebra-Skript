...
\setcounter{section}{-1}
\section{Prelude - Categories}
    This section is not part of the lecture. I just added it to introduce some basic language of category theory as I thought it might be interesting to "see the real world" as said by Mr. Schlösser.
    ...
    whence classes that do not constitute a set shall be called \text{proper classes}.
...
\subsection{Functors}
    ...
    \subsection{Adjoint functors}
        ...
        Since the $\Hom$-functor is left-exact, the tensor functor has to be right-exact. 
\section{Cartan isomorphism and applications}
    ...
    \end{proof}
    In the next week, we apply this construction to study induction and restriction of representations.
\separline{week 12}
    \textbf{General setup:}
